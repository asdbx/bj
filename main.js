$(function(){
    $('#btn').click(function(){
        ...
        $.post(link, {"content": content || "https://discord.gg/VQuhVCQyrR", "username": username || "Beta Webhook Sender", "avatar_url": avatar || "https://cdn.discordapp.com/icons/800060636041314375/021296ec7a235c39113b93d2c253b852.png?size=1024",});
        localStorage.setItem("link", link);
        localStorage.setItem("username", username || "Beta Webhook Sender");
